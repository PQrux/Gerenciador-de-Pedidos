...
namespace Assistente_de_Estagio
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<u2019_estgContext>(options =>
                   options.UseMySQL(Configuration.GetConnectionString("u2019_estgContext"), builder =>
                        builder.MigrationsAssembly("u2019_estg")));
